...
class OmniPackLiveWide extends Component {
    ...
    render() {
        return (
            <div>
                ...
                {/* WebGL Live Demo */}
                <section className={'opack-container'} style={{maxWidth: 1408}}>
                    <div className="opack-content column">
                        <Title align={'center'}>Even in web</Title>
                        <Text align={'center'}>
                            Use web version of OmniPack to create awesome demonstrations.
                        </Text>
                            <iframe className="webgl-frame-wide" src="demo.html"
                                    frameBorder="0"/>
                    </div>
                </section>
...
export default OmniPackLiveWide;
