        ...
        <div className="footer-content">
            <div className="left-side">
                ...
                <div className="text-links">
                    ...
                    <a href="/omnipack">OmniPack</a>
                    <a href="/omnifit">OmniFit</a>
                    {/* <a href="/blog">Blog</a> */}
                </div>
            </div>
            <div className="right-side">
                <p className="copy">All rights reserved. © 2021 Native Robotics</p>
            </div>
        </div>
    </footer>;
}
